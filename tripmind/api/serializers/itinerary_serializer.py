...
class ItineraryModelSerializer(serializers.ModelSerializer):
    ...
    def get_share_url(self, obj):
        ...
        if request and obj.is_public and obj.is_share_valid():
            return request.build_absolute_uri(f"/api/tripmind/share/itinerary/{obj.share_id}/")
        return None
...
class PublicShareSettingSerializer(serializers.Serializer):
    ...
    share_type = serializers.ChoiceField(choices=Itinerary.SHARE_TYPE_CHOICES, default='VIEW')
