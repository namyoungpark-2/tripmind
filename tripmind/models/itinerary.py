...
class Itinerary(models.Model):
    ...
    share_type = models.CharField(max_length=10, choices=SHARE_TYPE_CHOICES, default='NONE')
...
class SharedItinerary(models.Model):
    ...
    itinerary = models.ForeignKey(Itinerary, on_delete=models.CASCADE, related_name='shared_with')
    shared_with = models.ForeignKey(User, on_delete=models.CASCADE, related_name='shared_itineraries')
